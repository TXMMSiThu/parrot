...
echo Waiting By TXMM ❤ GAMING  | lolcat -a -d 500

apt install figlet -y

clear

figlet WELCOME TO TXMM GAMING | lolcat -a -d 13  -F 0.1 -t -p 3.0 -S 1  -f
...
if [ "$first" != 1 ];then
	...
	if [ ! -f $tarball ]; then
		...
		*)
		...
		wget "https://github.com/AndronixApp/AndronixOrigin/blob/master/Rootfs/Parrot/arm64/parrot-rootfs-arm64.tar.xz?raw=true" -O $tarball
...
echo ' Welcome to Andronix | parrot '
